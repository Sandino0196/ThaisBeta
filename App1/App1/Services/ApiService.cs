...
namespace App1.Services
{
    public class ApiService
    {
        ...
        public List<Lote> ProductosDulce()
        {
            ...
            lista.Add(new Lote() { CodigoProducto = 101, Descripcion = "Chicle Vitolero", Imagen = "ChicleV" ,DescripcionLote = "9 botes, 120 unidades c/u", Precio = 750 });
            lista.Add(new Lote() { CodigoProducto = 102, Descripcion = "Milky Way Minis", Imagen = "MilkyMini", DescripcionLote = "12 botes, 52 unidades c/u", Precio = 1450 });
            lista.Add(new Lote() { CodigoProducto = 103, Descripcion = "M&M's Minis", Imagen = "MMMinis", DescripcionLote = "12 botes, 52 unidades c/u", Precio = 1300 });
            lista.Add(new Lote() { CodigoProducto = 104, Descripcion = "Snickers Minis", Imagen = "SnicMini", DescripcionLote = "12 botes, 52 unidades c/u", Precio = 1450 });
            lista.Add(new Lote() { CodigoProducto = 105, Descripcion = "Snickers Barras", Imagen = "Snic", DescripcionLote = "8 displays, 52 unidades c/u", Precio = 4850 });
            lista.Add(new Lote() { CodigoProducto = 106, Descripcion = "Crayon Manzana", Imagen = "Manzana", DescripcionLote = "12 paquetes, 10 unidades c/u", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 107, Descripcion = "Crayon Mango", Imagen = "Mango", DescripcionLote = "12 paquetes, 10 unidades c/u", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 108, Descripcion = "Crayon Fresa", Imagen = "FresaC", DescripcionLote = "12 paquetes, 10 unidades c/u", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 109, Descripcion = "Crayon Uva", Imagen = "Uva", DescripcionLote = "12 paquetes, 10 unidades c/u", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 110, Descripcion = "Pachicleta", Imagen = "Pac10", DescripcionLote = "10 unidades Ristra", Precio = 0 });
            lista.Add(new Lote() { CodigoProducto = 111, Descripcion = "Pachicleta", Imagen = "Pac20", DescripcionLote = "20 unidades Bolsa", Precio = 350 });
            lista.Add(new Lote() { CodigoProducto = 112, Descripcion = "Trident Cool Bubble", Imagen = "CoolB", DescripcionLote = "12 paquetes, 12 unidades c/u", Precio = 2400 });
            lista.Add(new Lote() { CodigoProducto = 113, Descripcion = "Trident Fresh Mint", Imagen = "FreshM", DescripcionLote = "12 paquetes, 12 unidades c/u", Precio = 2400 });
            lista.Add(new Lote() { CodigoProducto = 114, Descripcion = "Trident Menta", Imagen = "Menta", DescripcionLote = "12 paquetes, 12 unidades c/u", Precio = 2400 });
            lista.Add(new Lote() { CodigoProducto = 115, Descripcion = "Trident Sandia", Imagen = "Sandia", DescripcionLote = "12 paquetes, 12 unidades c/u", Precio = 2400 });
            lista.Add(new Lote() { CodigoProducto = 116, Descripcion = "Trident Yerbabuena", Imagen = "Yerba", DescripcionLote = "12 paquetes, 12 unidades c/u", Precio = 2400 });
            lista.Add(new Lote() { CodigoProducto = 117, Descripcion = "Trident Fresa", Imagen = "FresaT", DescripcionLote = "30 paquetes, 18 unidades c/u", Precio = 1400 });
            lista.Add(new Lote() { CodigoProducto = 118, Descripcion = "Trident Fresa/Frutilla y Limon", Imagen = "FresaLim", DescripcionLote = "10 paquetes, 18 displays c/u", Precio = 1400 });
            lista.Add(new Lote() { CodigoProducto = 119, Descripcion = "Trident Menta y Vainilla", Imagen = "MentaVai", DescripcionLote = "10 paquetes, 18 displays c/u", Precio = 1400 });
            lista.Add(new Lote() { CodigoProducto = 120, Descripcion = "Trident Uva y Naranja", Imagen = "UvaNar", DescripcionLote = "10 paquetes, 18 displays c/u", Precio = 1400 });
            ...
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Azul bebe (Numero 7)", Imagen = "GloboAzulBebe", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Aqua estandar (Numero 7 y 9)", Imagen = "GloboAquaEstandar", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Azul estandar (Numero 7 y 9)", Imagen = "GloboAzulEstandar", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Azul turquesa (Numero 7 y 9)", Imagen = "GloboAzulTurquesa", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Coral (Numero 7 y 9)", Imagen = "GloboCoral", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Fucsia (Numero 7 y 9)", Imagen = "GloboFucsia", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Lavanda (Numero 7 y 9)", Imagen = "GloboLavanda", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Rojo (Numero 7 y 9)", Imagen = "GloboRojo", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Rosa (Numero 7 y 9)", Imagen = "GloboRosa", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Durazno (Numero 9)", Imagen = "GloboDurazno", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Naranja (Numero 7 y 9)", Imagen = "GloboNaranja", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Mostaza (Numero 7 y 9)", Imagen = "GloboMostaza", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Dorado (Numero 9)", Imagen = "GloboDorado", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Amarillo estandar (Numero 7 y 9)", Imagen = "GloboAmarillo", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Lima (Numero 7 y 9)", Imagen = "GloboLima", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Verde (Numero 7 y 9)", Imagen = "GloboVerde", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Negro estandar (Numero 9)", Imagen = "GloboNegroEstandar", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Plateado estandar (Numero 9)", Imagen = "GloboPlateadoEstandar", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Blanco estandar (Numero 7 y 9)", Imagen = "GloboBlancoEstandar", DescripcionLote = "50 bolsas de 100 unidades por caja", Precio = 42 });
            lista.Add(new Lote() { CodigoProducto = 1601, Descripcion = "Globo Rifa", Imagen = "GlobosLogo", DescripcionLote = "50 cartones de 140 unidades por caja", Precio = 3500 });
            return lista;
        }
        ...
        {
            var lista = new List<Lote>();
            lista.Add(new Lote() { CodigoProducto = 201, Descripcion = "Glade Jardin Campestre", Imagen = "GladeCamp", DescripcionLote = "12 unidades de 400ml por caja", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 202, Descripcion = "Glade Hawaiian Breeze", Imagen = "GladeHawai", DescripcionLote = "12 unidades de 400ml por caja", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 203, Descripcion = "Glade Campos de Lavanda", Imagen = "GladeLavanda", DescripcionLote = "12 unidades de 400ml por caja", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 204, Descripcion = "Glade Manzana y Canela", Imagen = "GladeManzana", DescripcionLote = "12 unidades de 400ml por caja", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 205, Descripcion = "Glade Frescura Matinal", Imagen = "GladeMatinal", DescripcionLote = "12 unidades de 400ml por caja", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 206, Descripcion = "Glade Floral Perfection", Imagen = "GladeFloral", DescripcionLote = "12 unidades de 400ml por caja", Precio = 600 });
            lista.Add(new Lote() { CodigoProducto = 207, Descripcion = "Glade Vainilla", Imagen = "GladeVainilla", DescripcionLote = "12 unidades de 400ml por caja", Precio = 600 });

            lista.Add(new Lote() { CodigoProducto = 208, Descripcion = "Baygon Ultra", Imagen = "Baygon", DescripcionLote = "12 unidades de 400ml por caja", Precio = 750 });
            lista.Add(new Lote() { CodigoProducto = 209, Descripcion = "Oko Multiusos", Imagen = "okoPe", DescripcionLote = "12 unidades de 200ml por caja", Precio = 540 });
            ...
            lista.Add(new Lote() { CodigoProducto = 211, Descripcion = "Raid MAX", Imagen = "RaidMax", DescripcionLote = "12 unidades de 400ml por caja", Precio = 865 });
            lista.Add(new Lote() { CodigoProducto = 212, Descripcion = "Raid Casa y Jardin", Imagen = "RaidCasa", DescripcionLote = "12 unidades de 400ml por caja", Precio = 850 });
            lista.Add(new Lote() { CodigoProducto = 213, Descripcion = "Raid Mata Moscas y Mosquitos", Imagen = "RaidMos", DescripcionLote = "12 unidades de 400ml por caja", Precio = 850 });
            lista.Add(new Lote() { CodigoProducto = 214, Descripcion = "Raid Mata Cucarachas, Moscas y Mosquitos", Imagen = "RaidCuca", DescripcionLote = "12 unidades de 400ml por caja", Precio = 755 });
            ...
            lista.Add(new Lote() { CodigoProducto = 228, Descripcion = "Downy Passion", Imagen = "DownyPassG", DescripcionLote = "6 unidades de 3 Litros por caja", Precio = 650 });
            ...
            lista.Add(new Lote() { CodigoProducto = 231, Descripcion = "Downy Floral", Imagen = "DownyFloralXXL", DescripcionLote = "8.5 Litros por unidad", Precio = 300 });

            lista.Add(new Lote() { CodigoProducto = 232, Descripcion = "Suavitel Fresa y Chocolate", Imagen = "SuaviFresa", DescripcionLote = "12 unidades de 750ml por caja", Precio = 320 });
            lista.Add(new Lote() { CodigoProducto = 233, Descripcion = "Suavitel Aqua", Imagen = "SuaviAqua", DescripcionLote = "12 unidades de 850ml por caja", Precio = 350 });
            lista.Add(new Lote() { CodigoProducto = 234, Descripcion = "Suavitel Abrazo de sol", Imagen = "SuaviAbrazo", DescripcionLote = "12 unidades de 750ml por caja", Precio = 320 });
            lista.Add(new Lote() { CodigoProducto = 235, Descripcion = "Suavitel Aroma de Durazno", Imagen = "SuaviDur", DescripcionLote = "12 unidades de 850ml por caja", Precio = 350 });
            lista.Add(new Lote() { CodigoProducto = 236, Descripcion = "Suavitel Orquideas Blancas", Imagen = "SuaviOrquidea", DescripcionLote = "12 unidades de 850ml por caja", Precio = 350 });
            lista.Add(new Lote() { CodigoProducto = 237, Descripcion = "Suavitel Toronja y Flor de Cereza", Imagen = "SuaviToronja", DescripcionLote = "12 unidades de 750ml por caja", Precio = 320 });
            lista.Add(new Lote() { CodigoProducto = 238, Descripcion = "Suavitel Primavera", Imagen = "SuaviPrima", DescripcionLote = "4 unidades de 3 Litros por caja", Precio = 360 });
            lista.Add(new Lote() { CodigoProducto = 239, Descripcion = "Suavitel Aroma de Sol", Imagen = "SuaviSol", DescripcionLote = "4 unidades de 3 Litros por caja", Precio = 360 });
            return lista;
        }
        ...
        {
            var lista = new List<Lote>();
            lista.Add(new Lote() { CodigoProducto = 501, Descripcion = "Axe Black Night", Imagen = "AxeBN", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 502, Descripcion = "Axe Dark Temptation", Imagen = "AxeDT", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 503, Descripcion = "Axe Anarchy", Imagen = "AxeAnarchy", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 504, Descripcion = "Axe Black", Imagen = "AxeBlack", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 505, Descripcion = "Axe Collision", Imagen = "AxeCollision", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 506, Descripcion = "Axe Gold Temptation", Imagen = "AxeGT", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 507, Descripcion = "Axe Excite", Imagen = "AxeExcite", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 508, Descripcion = "Axe You", Imagen = "AxeYou", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 509, Descripcion = "Axe Conviction", Imagen = "AxeConviction", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            ...
            lista.Add(new Lote() { CodigoProducto = 511, Descripcion = "Axe Collision + 25", Imagen = "AxeCollision25", DescripcionLote = "12 unidades de 115ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 512, Descripcion = "Axe Young", Imagen = "AxeYoung", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 513, Descripcion = "Axe Anarchy for Her", Imagen = "AxeAnarchyM", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 514, Descripcion = "Axe Dark Temptation Seco", Imagen = "AxeDTSeco", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 515, Descripcion = "Axe Black Seco", Imagen = "AxeBlackSeco", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 516, Descripcion = "Axe Adrenaline", Imagen = "AxeAdrenaline", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 517, Descripcion = "Axe Gold Temptation Seco", Imagen = "AxeDTSeco", DescripcionLote = "12 unidades de 90ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 518, Descripcion = "Axe Anarchy for Her + 25", Imagen = "AxeAnarchyM25", DescripcionLote = "12 unidades de 115ml por caja", Precio = 580 });
            lista.Add(new Lote() { CodigoProducto = 519, Descripcion = "Axe Apollo", Imagen = "AxeApolloB", DescripcionLote = "12 unidades de 54 gramos por caja", Precio = 520 });
            lista.Add(new Lote() { CodigoProducto = 520, Descripcion = "Axe You", Imagen = "AxeYouB", DescripcionLote = "12 unidades de 54 gramos por caja", Precio = 520 });
            lista.Add(new Lote() { CodigoProducto = 521, Descripcion = "Axe Black", Imagen = "AxeBlackB", DescripcionLote = "12 unidades de 54 gramos por caja", Precio = 520 });
            lista.Add(new Lote() { CodigoProducto = 522, Descripcion = "Axe Collision", Imagen = "AxeCollisionB", DescripcionLote = "12 unidades de 54 gramos por caja", Precio = 520 });
            lista.Add(new Lote() { CodigoProducto = 523, Descripcion = "Axe Dark Temptation", Imagen = "AxeDTB", DescripcionLote = "12 unidades de 54 gramos por caja", Precio = 520 });
            lista.Add(new Lote() { CodigoProducto = 524, Descripcion = "Axe Excite", Imagen = "AxeExciteB", DescripcionLote = "12 unidades de 54 gramos por caja", Precio = 520 });
            lista.Add(new Lote() { CodigoProducto = 525, Descripcion = "Axe Gold", Imagen = "AxeGoldB", DescripcionLote = "12 unidades de 54 gramos por caja", Precio = 520 });
            lista.Add(new Lote() { CodigoProducto = 526, Descripcion = "Axe Kilo", Imagen = "AxeKiloB", DescripcionLote = "12 unidades de 54 gramos por caja", Precio = 520 });
            lista.Add(new Lote() { CodigoProducto = 527, Descripcion = "Axe Dark Temptation Value Pack", Imagen = "AxeDTPaquete", DescripcionLote = "18 unidades de 90ml por caja", Precio = 800 });
            ...
            lista.Add(new Lote() { CodigoProducto = 802, Descripcion = "Shampoo H&S Proteccion Caida", Imagen = "HeadPC", DescripcionLote = "12 unidades de 400ml por caja", Precio = 860 });
            ...
            lista.Add(new Lote() { CodigoProducto = 804, Descripcion = "Shampoo H&S con Old Spice", Imagen = "HeadOS", DescripcionLote = "12 unidades de 400ml por caja", Precio = 860 });
            lista.Add(new Lote() { CodigoProducto = 805, Descripcion = "Shampoo H&S 3 en 1 Men", Imagen = "Head3en1", DescripcionLote = "12 unidades de 400ml por caja", Precio = 860 });
            lista.Add(new Lote() { CodigoProducto = 806, Descripcion = "Shampoo H&S Manzana Fresh", Imagen = "HeadMF", DescripcionLote = "12 unidades de 400ml por caja", Precio = 860 });
            ...
            lista.Add(new Lote() { CodigoProducto = 808, Descripcion = "Shampoo H&S Relax Control Comezon", Imagen = "HeadRCC", DescripcionLote = "12 unidades de 400ml por caja", Precio = 860 });
            lista.Add(new Lote() { CodigoProducto = 809, Descripcion = "Shampoo H&S Suave y Manejable", Imagen = "HeadSM", DescripcionLote = "12 unidades de 400ml por caja", Precio = 860 });

            lista.Add(new Lote() { CodigoProducto = 901, Descripcion = "Shampoo Control Caida", Imagen = "TRESCC", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 902, Descripcion = "Shampoo Keratin Smooth", Imagen = "TRESKS", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 903, Descripcion = "Shampoo Rizos Perfectos", Imagen = "TRESRP", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 904, Descripcion = "Shampoo Repair Rituals", Imagen = "TRESRR", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 905, Descripcion = "Shampoo Oil Radiante", Imagen = "TRESOR", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 906, Descripcion = "Shampoo Liso y Sedoso", Imagen = "TRESLS", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 907, Descripcion = "Shampoo Split Remedy", Imagen = "TRESSR", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 908, Descripcion = "Shampoo Proteccion Termica", Imagen = "TRESPT", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 909, Descripcion = "Acondicionador Keratin Smooth", Imagen = "TRESAKS", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 910, Descripcion = "Acondicionador Blindaje Platinum", Imagen = "TRESABP", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 911, Descripcion = "Acondicionador Oil Radiante", Imagen = "TRESAOR", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 912, Descripcion = "Acondicionador Hidratacion Profunda", Imagen = "TRESAHP", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 913, Descripcion = "Acondicionador Repair Rituals", Imagen = "TRESARR", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 914, Descripcion = "Acondicionador Liso y Sedoso", Imagen = "TRESALS", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
            lista.Add(new Lote() { CodigoProducto = 915, Descripcion = "Acondicionador Split Remedy", Imagen = "TRESASR", DescripcionLote = "12 unidades de 750ml por caja", Precio = 1000 });
